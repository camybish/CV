...
I have worked and team environments before this, but I feel that my time at Makers Academy was a fantastic showcase of how well I can work in a team environment. I feel that the best example of this was my work on the final project, Battle Tetris. For this final project, we settled on my idea for a Tetris clone that is played between two people on the same grid. With this being my idea, I felt I had a level of responsibility to ensure that this gets made with great care and presented as such at the end of the 2 weeks; so I took charge of the initial conception stage. Since none of us had made a game before, I decided that the first week of this project should be dedicated to figuring out how to make a game engine with technologies that we are familiar with. It took a day to deliberate our strategy but of course, this wasn't smooth sailing. After the first week, we had a game engine but not quite our Minimum Viable Product (movable falling pieces). 
...
It's safe to say my work with Engage Education as a Learning Support Assistant gave me a new level of resolve, both through learning on the job how to best work with kids and the tribulations of working on contract. Before starting as a learning support assistant, I went into the role having only some experience with tutoring. I learnt an incredible amount in a practical sense. There was plenty of challenging behaviour, but I came into each school with new ideas as to how to manage this and over time, I gained a considerable skill set through this persistence and in turn it was incredibly fulfilling. More contracts based challenges arose during the summer of 2022. I had a notable contract be cut short due to a logistical problem and I was devastated. It was the only work that my agency had that was available during the summer holidays. So to resolve this, I signed up with a different agency that gave me day work at various different nurseries in order to make up for the lack of work during that summer holiday period. Thanks to this resilience, I was repaid with work at Engage for a 2 term (half year) period at Burgess Hill Academy. This role offered a great opportunity to demonstrate the skills I had learnt up until that point and make true connections and a  difference at this institution.
...
- We used:
    ...
    - This led us well into using the **MERN** stack (Mongoose, Express, React, Node.js + Cypress) to create a Facebook clone website as a way of getting accustomed.
 
- Throughout the Sinatra web app, the Facebook clone, and the final project, we realized as a cohort and within our respective teams, how important communication and planning are when bringing something like this together. Utilising an Agile working environment, setting out a team charter before starting, and working within the tickets of each sprint; These were processes that our cohort worked to continually improve, and the more we did, the happier we were with the results.
- Agile Development and working collaboratively with a Git repository were both things that were a definite challenge to overcome due to our team being inexperienced with both. We ran into problems with how tickets could best be utilised in Agile Development and took this information forward to new projects. One ticket I was working on in particular, I was determined to finish in a particular way. A result I ended up being proud of but one that took too much time for the week we had to complete this AirBnB clone.
- Our process of understanding Git repositories and how merging and pull requests was more deliberate. We found through some trial and error that it was best to protect the main branch by having 2 accounts approve any pull requests made. The reviewers should also compile the branch on their respective machine to check for any issues or missing features as well as run all tests and check coverage. Of course, some of these details were learned in later projects with a healthy bit of trial and error.
- 
